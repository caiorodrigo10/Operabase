...
export const message_attachments = pgTable("message_attachments", {
  ...
  // Supabase Storage Integration (FASE 1 - Nova estrutura) - TEMPORARILY DISABLED
  ...
  // index("idx_attachments_storage_path").on(table.storage_path), // DISABLED - Column not in DB yet
]);
