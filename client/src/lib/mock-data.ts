...
export const mockMessages: Message[] = [
  ...
  { id: 19, conversation_id: 2, type: 'received', content: "Boa ideia! Vou comprar um desses organizadores. Aproveito para perguntar: minha glicemia hoje cedo estava 160. Está alta?", timestamp: "14:39", sender_name: "João Santos" },
  { id: 20, conversation_id: 2, type: 'sent_user', content: "Sim, está um pouco elevada. O ideal é manter entre 70-130 em jejum. Você tomou café da manhã antes de medir?", timestamp: "14:41", sender_name: "Dr. Carlos" },
  { id: 21, conversation_id: 2, type: 'received', content: "Não, foi em jejum mesmo. Ontem comi uma sobremesa no almoço, pode ter influenciado?", timestamp: "14:42", sender_name: "João Santos" },
  { id: 22, conversation_id: 2, type: 'sent_user', content: "Pode sim. Vamos monitorar por alguns dias. Continue medindo em jejum e anote os valores. Se persistir alto, ajustamos a medicação na próxima consulta.", timestamp: "14:44", sender_name: "Dr. Carlos" },
  { id: 23, conversation_id: 2, type: 'received', content: "Perfeito! Obrigado pelas orientações, doutor. Vou anotar tudo certinho.", timestamp: "14:45", sender_name: "João Santos" },
