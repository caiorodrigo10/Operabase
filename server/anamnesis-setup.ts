      ...
      const defaultTemplates = [
        {
          ...
          fields: {
            questions: [
              ...
              { id: '4', text: 'Email', type: 'email', required: false },
              { id: '5', text: 'Profissão', type: 'text', required: false },
              { id: '6', text: 'Estado civil', type: 'select', options: ['Solteiro(a)', 'Casado(a)', 'Divorciado(a)', 'Viúvo(a)', 'União estável'], required: false },
              { id: '7', text: 'Queixa principal', type: 'textarea', required: true },
              { id: '8', text: 'Histórico da doença atual', type: 'textarea', required: true },
              { id: '9', text: 'Medicamentos em uso', type: 'textarea', required: false },
              { id: '10', text: 'Alergias', type: 'textarea', required: false },
              { id: '11', text: 'Histórico familiar de doenças', type: 'textarea', required: false },
              { id: '12', text: 'Hábitos (fumo, álcool, exercícios)', type: 'textarea', required: false }
            ]
          }
        },
        {
