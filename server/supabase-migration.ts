...
export class SupabaseMigration {
  ...
  private async createTables(): Promise<void> {
    console.log('📋 Criando estrutura das tabelas no Supabase...');
    ...
    // Executar comandos SQL diretamente usando o cliente Supabase
    try {
      // Como o Supabase não tem exec_sql, vamos usar uma abordagem diferente
      ...
      console.log('Continuando com criação de tabelas...');
    }

    console.log('✅ Estrutura das tabelas criada no Supabase');
  }
